...
public class ProjectPh1
{
	...
	public static void main(String[] args) { 
		...
		System.out.println("Developed By	:- A.Sharathchandra");
		...
		do {
			File file = new File("D:\\Sharath\\ProjectPh1\\WorkFile\\JavaProject\\src\\Filess\\");
			...
			case 2:      //  To Add File In To The Directory
				...
				try {
					...
					file = new File("D:\\Sharath\\ProjectPh1\\WorkFile\\JavaProject\\src\\Filess\\" + str);//path where you want to add a file
			...
			case 3://To Delete a file In the Directory
				...
				File file1 = new File("D:\\Sharath\\ProjectPh1\\WorkFile\\JavaProject\\src\\Filess\\"+ str);
